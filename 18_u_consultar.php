			...
			<div class="col-9">
				<div class="tab-content" id="v-pills-tabContent">
					...
					dby="v-pills-profile-tab">
						...
						<div class="row justify-content-center">
							<div class="col-sm-12 sm-col-4 col-4align-self-center text-center">
								<p>- U S U A R I O S - C O N S U L T A R -</p>
								<p></p>
							</div>
						</div>
						<br>
						...
						<form  method="post" >
							...
							<div class="row form-group justify-content-center ">
								...
								<div class="col-sm-4 ">
									<input type="text" class="form-control" id="buscaru" name="buscaru" placeholder="id o email o tipo" required=”required”>
								</div>
							</div>
							<!-- <div class="row justify-content-center">
					...
					<div class="tab-pane fade" id="v-tabcursos" role="tabpanel" aria-labelledby="v-pills-messages-tab">
						...
						<div class="row justify-content-center text-center">
							<div class="col-xs-12 col-4 align-self-center text-center">
								<a class="btn btn-primary textcolorb" href="http://localhost:8080/vincula/insertarC.php" role="button">Agregar</a>
							</div>
							<div class="col-xs-12 col-4 align-self-center text-center">
...
<script>
	...
	$(document).on('keyup', '#buscaru', function(){
		var valor = $(this).val();
		if(valor != ""){
			buscar_datos(valor);
		}
