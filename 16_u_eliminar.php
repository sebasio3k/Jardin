			...
			<div class="search" id="search">
				<table class="search-table" id="searchTable" name="searchTable">
					...
					<tbody>
						...
						<tr>
							<td><a href="http://localhost:8080/vincula/insertar.jsp">Insertar Producto</a></td>
						</tr>
						<tr>
			...
			<div class="col-9">
				<div class="tab-content" id="v-pills-tabContent">
					...
					<div class="tab-pane fade" id="v-tabcursos" role="tabpanel" aria-labelledby="v-pills-messages-tab">
						...
						<div class="row justify-content-center text-center">
							<div class="col-xs-12 col-4 align-self-center text-center">
								<a class="btn btn-primary textcolorb" href="http://localhost:8080/vincula/insertarC.jsp" role="button">Agregar</a>
							</div>
							<div class="col-xs-12 col-4 align-self-center text-center">
					...
					<div class="tab-pane fade" id="v-tabproductos" role="tabpanel" aria-labelledby="v-pills-settings-tab">
						...
						<div class="row justify-content-center text-center">
							<div class="col-xs-12 col-4 align-self-center text-center">
								<a class="btn btn-primary textcolorb" href="http://localhost:8080/vincula/insertarP.php" role="button">Agregar</a>
							</div>
							<div class="col-xs-12 col-4 align-self-center text-center">
